...
Legd_ang1_northf = [430:-1:270];                                           % L1 이동경로설정(NORTH)
...
Legd_ang1_southf = [110:1:270];                                            % L1 이동경로설정(SOUTH)
...
Legu_ang1_northf = [270:1:430];                      % L1 이동경로설정(NORTH)
...
Legu_ang1_southf = [270:-1:110];                    % L1 이동경로설정(SOUTH)
...
v = VideoWriter('stair_animation.mp4','MPEG-4');
v.FrameRate = 30;
v.Quality = 100;
open(v);
writeVideo(v,F);
