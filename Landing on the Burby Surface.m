...
Legu_ang1_north = [377:1:430,linspace(430,430,107)];                    % L1 이동경로설정(NORTH)
...
Legu_ang2_north = [377:1:430,linspace(430,430,107)];                    % L2 이동경로 설정(NORTH)
...
Legd_ang1_westf = [110:1:270];                                           % L1 이동경로설정(WEST)
...
Legd_ang1_northf = [430:-1:377,linspace(377,377,107)];                                           % L1 이동경로설정(NORTH)
...
Legd_ang1_southf = [110:1:200,linspace(200,200,70)];                                            % L1 이동경로설정(SOUTH)
...
Legu_ang1_westf = [270:-1:110];                                            % L1 이동경로설정(WEST)
...
Legu_ang1_northf = [377:1:430,linspace(430,430,107)];                      % L1 이동경로설정(NORTH)
...
Legu_ang1_southf = [200:-1:110,linspace(110,110,70)];                    % L1 이동경로설정(SOUTH)
...
for i_ptu = 1:length(Legu_theta1_west)                                       %애니매이션 실행 1부터theta_west크기까지 반복
    ...
    pause(0.01);                                                                  %0.08초 딜레이 0에가까울수록 빠름(drawnow함수 이용시 제일 빠름)
end
